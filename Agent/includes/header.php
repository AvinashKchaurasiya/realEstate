<header>
    <div id="sidenav-1" class="sidenav" role="navigation" data-hidden="false" data-accordion="true">
        <a class="ripple d-flex justify-content-center py-4" href="dashboard" data-ripple-color="primary" style="text-decoration: none;">
        ...
        <ul class="sidenav-menu" style="font-weight: bold;">
            <li class="sidenav-item">
                <a class="sidenav-link" href="dashboard" style="text-decoration: none;">
            ...
            <li class="sidenav-item">
                <a href="rating" class="sidenav-link" style="text-decoration: none;"><i class="bi bi bi-star-half pr-3"></i><span>Rating</span></a>
            </li>
        </ul>
    </div>
