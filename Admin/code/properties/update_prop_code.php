...
if (isset($_POST['update'])) {
    ...
    $update = "UPDATE properties SET title ='$title', description ='$desc',price ='$price',location='$location',city='$city',state='$state',country='$country',zip_code='$zip_code',prop_name='$category',bedrooms='$bedroom',bathrooms='$bathroom',area='$area',amenities='$amenities',availability='$availability',owner_name='$o_name',owner_contact='$o_contact' where id='$id'";
