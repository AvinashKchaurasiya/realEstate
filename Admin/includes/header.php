<header>
    <div id="sidenav-1" class="sidenav" role="navigation" data-hidden="false" data-accordion="true">
        <a class="ripple d-flex justify-content-center py-4" style="text-decoration: none;" href="dashboard" data-ripple-color="primary">
        ...
        <ul class="sidenav-menu" style="font-weight: bold;">
            <li class="sidenav-item ">
                <a class="sidenav-link link-item" style="text-decoration: none;" href="dashboard">
            ...
            <li class="sidenav-item">
                ...
                <ul class="sidenav-collapse">
                    <li class="sidenav-item">
                        <a href="properties" class="sidenav-link" style="text-decoration: none;">All Properties</a>
                    </li>
                    <li class="sidenav-item">
                        <a href="property_type" class="sidenav-link" style="text-decoration: none;">Property Type</a>
                    </li>
                </ul>
            </li>
            <li class="sidenav-item">
                ...
                <ul class="sidenav-collapse">
                    <li class="sidenav-item">
                        <a href="agent" class="sidenav-link" style="text-decoration: none;">Agent</a>
                    </li>
                    <li class="sidenav-item">
                        <a href="user" class="sidenav-link" style="text-decoration: none;">Usres</a>
                    </li>
                </ul>
            </li>
        </ul>
